...
public class SignUpActivityOLD extends AppCompatActivity {
    ...
    public void sendSms(View view){
        ...
        if(TextUtils.isEmpty(phoneNumberString)){
            Toast.makeText(SignUpActivityOLD.this, "Please enter your mobile number ", Toast.LENGTH_SHORT).show();
            return;
        }
        if( phoneNumberString.length()!=14){
            Toast.makeText(SignUpActivityOLD.this, "Please enter your valid phone number ", Toast.LENGTH_SHORT).show();
            return;
    ...
    public void verify(View v){
        ...
        if(TextUtils.isEmpty(enterededCodeString)){
            Toast.makeText(SignUpActivityOLD.this, "Please enter the varification code", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        ValueEventListener valueEventListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.child(uid).exists()){
                    ...
                    startActivity(new Intent(getApplicationContext(), UserInfoFormActivityOLD.class));
                }
